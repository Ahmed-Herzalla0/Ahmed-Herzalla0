...
if __name__ == "__main__":
    for fname in ["dark_mode.svg", "dark_mode_v2.svg", "dark_mode_v3.svg", "dark_mode_v4.svg", "dark_mode_v5.svg"]:
        with open(f"/home/ahmad/Desktop/Ahmed-Herzalla0/{fname}", "w") as f:
            f.write(build_svg(dark=True))
    for fname in ["light_mode.svg", "light_mode_v2.svg", "light_mode_v3.svg", "light_mode_v4.svg", "light_mode_v5.svg"]:
        with open(f"/home/ahmad/Desktop/Ahmed-Herzalla0/{fname}", "w") as f:
            f.write(build_svg(dark=False))
    print("New ASCII art SVGs generated successfully!")
